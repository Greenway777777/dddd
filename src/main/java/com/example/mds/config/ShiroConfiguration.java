...
import com.example.mds.filter.URLPathMatchingFilter;
import com.example.mds.realm.MdsRealm;
...
public class ShiroConfiguration {
    ...
    public SecurityManager securityManager() {
        ...
        securityManager.setRealm(getMdsRealm());
    ...
    @Bean
    public MdsRealm getMdsRealm() {
        MdsRealm mdsRealm = new MdsRealm();
        mdsRealm.setCredentialsMatcher(hashedCredentialsMatcher());
        return mdsRealm;
    }
